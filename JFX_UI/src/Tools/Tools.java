...
public class Tools {
    ...
    public ObservableList<PersonTableData> getPersonTableViewData(String sql) {
        ...
        for (int i = 0; i < list.size(); i++) {
           ...
           PersonTableData td = new PersonTableData(String.valueOf(r.getId()), r.getName(), r.getSex(),String.valueOf(r.getAge()) , r.getAdress(),String.valueOf(r.getWenhua()), r.getIncome(), String.valueOf(r.getImportant()));
            data.add(td);
        }
        return data;
    }
